...
6. **Расчет итоговых рангов R_FIN:**
   ...
   - Веса (weight_od, weight_ra, weight_ps) задаются в конфигурации группы (DefaultsConfig)
...
- `weight_od: float` - Вес для группы OD при расчете итогового ранга R_FIN (по умолчанию 0.33)
- `weight_ra: float` - Вес для группы RA при расчете итогового ранга R_FIN (по умолчанию 0.33)
- `weight_ps: float` - Вес для группы PS при расчете итогового ранга R_FIN (по умолчанию 0.34)
...
- `_calculate_final_ranks(calculated_df: pd.DataFrame, config_manager) -> pd.DataFrame` - Рассчитывает итоговые ранги R_FIN для каждого месяца и определяет лучший месяц для каждого КМ
...
- `weight_od`: Вес для группы OD при расчете итогового ранга (по умолчанию 0.33)
- `weight_ra`: Вес для группы RA при расчете итогового ранга (по умолчанию 0.33)
- `weight_ps`: Вес для группы PS при расчете итогового ранга (по умолчанию 0.34)
...
**Технические детали:**
- Веса задаются в блоке `defaults=DefaultsConfig(...)` для каждой группы (по умолчанию: weight_od=0.33, weight_ra=0.33, weight_ps=0.34)
...
- Веса для расчета итогового ранга R_FIN задаются в блоке `defaults=DefaultsConfig(...)` для каждой группы
